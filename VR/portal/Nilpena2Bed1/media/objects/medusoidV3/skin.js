...
// Filename: vftObjectSolarSpellNoR.ggsk
// Generated Sat Feb 18 12:41:02 2017
	...
	this.addSkin=function() {
		...
		this._directions.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				...
				this.style.top=Math.floor(-19 + h) + 'px';
			}
		}
		hs ='position:absolute;';
		hs+='left: 31px;';
		...
		this._directions.ggTextDiv.innerHTML="This object cannot rotate";
